    ...
    return (
        ...
        <div id="aboutus-section">
            <div className='mx-auto max-w-7xl px-4 py-24 my-32 lg:px-10 bg-[#4034d2] rounded-3xl relative'>
                ...
                <h3 className='text-center text-white text-lg tracking-widest'>ssABOUT US</h3>
                <h4 className='text-center text-4xl text-white lg:text-65xl font-bold'>Know more about us.</h4>
                <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 my-16 gap-x-16 lg:gap-x-32'>
                    {Aboutdata.map((item, i) => (
                        <div key={i} className='hover:bg-navyblue hover:cursor-pointer bg-white rounded-3xl mt-16 pt-10 pl-8 pb-10 pr-6 shadow-xl group'>
