...
const FAQ = () => {
    return (
        <div id="faq-section" className='mx-auto max-w-7xl py-24 lg:px-8 bg-faqblue rounded-2xl my-16 faq-bg'>
            ...
            <h2 className='text-4xl lg:text-6xl font-semibold text-center text-white'>Frequently asked <br/> questions.
            </h2>
                    ...
                    <Disclosure as="div" className="mt-2">
                        {({open}) => (
                            <>
                                ...
                                <Disclosure.Panel
                                    className="px-4 pt-4 pb-2 text-base text-black font-normal opacity-50">
                                    ჩვენი კურსების გავლის შემდეგ გექნებათ სრულყოფილი საბაზისო ცოდნა კონკრეტული
