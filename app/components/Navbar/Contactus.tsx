...
const Contactusform = () => {
    ...
    const handleClick = () => {
        setIsOpen(false)
        userRegister(inputValues).then((res: {message:string}) => {
            Swal.fire({
                icon: 'success',
                title: 'გილოცავთ!',
                text: res.message,
                            ...
                            >
                                <Dialog.Panel
                                    ...
                                    <div className="py-8 lg:py-8 px-4 mx-auto max-w-screen-md">
                                        ...
                                        <p className="mb-8 lg:mb-16 mt-8 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">რეგისტრაციისთვის
                                            შეავსეთ მოცემული ველები</p>
                                        <form action="#" className="space-y-8" onSubmit={handleSubmit}>
                                            <div>
                                                <label htmlFor="text"
                                                       className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">სახელი
                                                    და გვარი</label>
                                                <input
                                                    id="text"
                                                    name="fullName"
                                            ...
                                            <div className="sm:col-span-2">
                                                <label htmlFor="message"
                                                       className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">სამოტივაციო
                                                    წერილი</label>
                                                <textarea
                                                    id="motivationLetter"
